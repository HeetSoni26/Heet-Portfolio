...
const socialBentoData: SocialBentoItem[] = [
  {
    ...
    name: 'GitHub',
    handle: '@HeetSoni26',
    url: 'https://github.com/HeetSoni26',
    icon: Github,
  ...
  },
  {
    ...
    name: 'LinkedIn',
    handle: 'Heet Soni',
    url: 'https://www.linkedin.com/in/heet-soni-8a9082273/',
    icon: Linkedin,
  ...
  },
  {
    ...
    name: 'Instagram',
    handle: '@heetsoni__',
    url: 'https://www.instagram.com/heetsoni__/',
    icon: Instagram,
  ...
  },
  {
    id: 'email',
    name: 'Email',
    handle: 'heetks2607@gmail.com',
    url: 'mailto:heetks2607@gmail.com',
    icon: Mail,
  ...
  },
  {
    id: 'phone',
    name: 'Phone',
    handle: '+91 99093 42367',
    url: 'tel:+919909342367',
    icon: Phone,
  ...
  },
  {
    ...
    name: 'Discord',
    handle: 'heet_ks',
    url: 'https://discordapp.com/users/heet_ks',
    icon: MessageSquare,
            ...
            >
              ...
              <div className="flex justify-between items-center border-b border-neutral-100 pb-2.5 z-10 mt-1">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[9px] font-bold tracking-[0.1em] text-neutral-500 font-jakarta">SONI</span>
                </div>
